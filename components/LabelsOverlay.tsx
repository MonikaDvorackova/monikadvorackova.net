  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          {/* Header (sticky) */}
          <div className="page-gutter-x sticky top-0 z-10 bg-[#F4EEE8]/90 dark:bg-neutral-900/90 backdrop-blur border-b border-neutral-200/70 dark:border-neutral-800 pt-3 pb-2 md:rounded-t-2xl">
            <div className="mx-auto max-w-5xl">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={onCloseAction}
                  className="h-10 px-3 rounded-md border border-blue-600/40 bg-white/80 text-xs text-blue-700 hover:bg-white"
          ...
          <div className="page-gutter-x flex-1 overflow-y-auto py-4 md:py-8">
          ...
          {/* Footer (volitelný) */}
          <div className="page-gutter-x sticky bottom-0 bg-[#F4EEE8]/90 dark:bg-neutral-900/90 backdrop-blur border-t border-neutral-200/70 dark:border-neutral-800 py-3 md:rounded-b-2xl">
