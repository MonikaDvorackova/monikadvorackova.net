...
flowchart LR
  ...
  subgraph Rust["Rust Governance Core (open source core)"]
    C1["Commands"]
    C2["Validation"]
  ...
  style Rust stroke:#2563eb,stroke-width:2px,fill:#ffffff
  style OS stroke:#2563eb,stroke-width:2px,fill:#ffffff,color:#2563eb
```
...
[GitHub — aigov-compliance-engine](https://github.com/MonikaDvorackova/aigov-compliance-engine)

[GovBase — dashboard](https://govbase.dev)