...
tags:
  ...
  - Compliance
  - AI Governance
tldr: "OpenAI released GPT-oss, its first open-weight model on GPT-4–class architecture—aligned with the EU Code of Practice and transparency expectations under the AI Act (weights, system card, benchmarks, limited licensing)."
---
